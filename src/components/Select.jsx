      ...
      <div className="flex">
        ...
        <div className="w-screen">
          <div className="h-screen bg-[#30093f] p-0 m-0 flex flex-col items-center font-dm-sans">
            <div className="text-3xl text-center mt-[5vh] text-yellow-400 font-dm-sans max-md:text-lg">
              Select your activity level
            </div>
            <div className=" h-[70vh] flex flex-col justify-around">
              <div
                className="w-96 h-10 bg-[#1f0729] rounded-full text-white text-[20px] flex justify-center items-center relative cursor-pointer hover:text-white hover:bg-yellow-600 max-md:w-64 "
                onClick={() => {
                  setactivityLevel(1.2);
                }}
              >
                Sedentary
                <p className=" text-[15px] absolute top-11 left-[50%] -translate-x-1/2 text-white max-md:text-[8px]">
